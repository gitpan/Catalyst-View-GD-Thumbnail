# This Makefile is for the Catalyst::View::GD::Thumbnail extension to perl.
#
...
#     ABSTRACT => q[Catalyst view to resize images for thumbnails]
#     AUTHOR => [q[Nick Logan (ugexe) <F<ug@skunkds.com>>]]
#     BUILD_REQUIRES => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.36] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Catalyst-View-GD-Thumbnail]
#     LICENSE => q[perl]
#     NAME => q[Catalyst::View::GD::Thumbnail]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0], Image::Info=>q[0], List::Util=>q[0], parent=>q[0], Catalyst::View=>q[0], ExtUtils::MakeMaker=>q[6.36], Image::Resize=>q[0] }
#     VERSION => q[0.10]
#     VERSION_FROM => q[lib/Catalyst/View/GD/Thumbnail.pm]
#     clean => { FILES=>q[README] }
...
MAKE = make
FULLEXT = Catalyst/View/GD/Thumbnail
BASEEXT = Thumbnail
PARENT_NAME = Catalyst::View::GD
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Catalyst/View/GD/Thumbnail.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Catalyst/Helper/View/GD/Thumbnail.pm \
	lib/Catalyst/View/GD/Thumbnail.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Catalyst/View/GD
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Catalyst/View/GD
...
TO_INST_PM = lib/Catalyst/Helper/View/GD/Thumbnail.pm \
	lib/Catalyst/View/GD/Thumbnail.pm

PM_TO_BLIB = lib/Catalyst/View/GD/Thumbnail.pm \
	blib/lib/Catalyst/View/GD/Thumbnail.pm \
	lib/Catalyst/Helper/View/GD/Thumbnail.pm \
	blib/lib/Catalyst/Helper/View/GD/Thumbnail.pm
...
DISTVNAME = Catalyst-View-GD-Thumbnail-0.10
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Catalyst/View/GD/Thumbnail.pm $(INST_MAN3DIR)/Catalyst::View::GD::Thumbnail.$(MAN3EXT) \
	  lib/Catalyst/Helper/View/GD/Thumbnail.pm $(INST_MAN3DIR)/Catalyst::Helper::View::GD::Thumbnail.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Nick Logan (ugexe) &lt;F&lt;ug@skunkds.com&gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Catalyst/View/GD/Thumbnail.pm blib/lib/Catalyst/View/GD/Thumbnail.pm \
	  lib/Catalyst/Helper/View/GD/Thumbnail.pm blib/lib/Catalyst/Helper/View/GD/Thumbnail.pm 
