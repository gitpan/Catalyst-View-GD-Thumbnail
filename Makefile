...
#     ABSTRACT_FROM => q[lib/Catalyst/View/GD/Thumbnail.pm]
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Catalyst view to resize images for thumbnails.'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Catalyst-View-GD-Thumbnail' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Catalyst view to resize images for thumbnails.",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Nick Logan <ug@skunkds.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Catalyst-View-GD-Thumbnail",' >> META_new.json
